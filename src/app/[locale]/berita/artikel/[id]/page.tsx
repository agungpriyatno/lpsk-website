      ...
      <section className="w-full aspect-[21/9] flex place-items-center justify-center relative">
        <Breadcrumb className="pt-5 absolute top-0 left-0">
          <BreadcrumbList className="m-0 text-white">
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage className="text-white">Artikel</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        <Image src={`https://picsum.photos/seed/artikel-${id}/2000/2000`} alt="image" fill className="object-cover h-full w-full -z-20" />
          ...
          {[1, 2, 3].map((item) => (
            <Link key={item} href={`/berita/artikel/${item}`}>
              ...
              "
                ...
                <h3 className="font-bold text-white">Buku Publikasi {item}</h3>
