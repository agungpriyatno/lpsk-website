    ...
    <main className="w-full">
      <section className="w-full aspect-[21/4] bg-primary-foreground flex place-items-center justify-center relative">
        <Breadcrumb className="pt-5 absolute top-0 left-0">
          <BreadcrumbList className="m-0">
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Buletin</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        <h1 className="text-center font-bold">Buletin Publikasi</h1>
      </section>
      ...
      <section className="w-full grid grid-cols-4 container pt-5 gap-2">
        {[1, 2, 3, 4, 5, 6, 7, 8].map((item) => (
          ...
          >
            <h3 className="font-bold text-white">Buletin Publikasi {item}</h3>
            ...
            <Image
              fill
              src={`https://picsum.photos/seed/Buletin-${item}/2000/2000`}
              alt="LPSK"
