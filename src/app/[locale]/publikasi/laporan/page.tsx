  ...
  return (
    <main className="w-full">
      <section className="w-full aspect-[21/4] bg-primary-foreground flex place-items-center justify-center relative">
        ...
        <h1 className="text-center font-bold">Laporan Publikasi</h1>
      </section>
      ...
      <section className="w-full grid grid-cols-4 container pt-5 gap-2">
        {[1, 2, 3, 4, 5, 6, 7, 8].map((item) => (
          ...
          >
            <h3 className="font-bold text-white">Laporan Publikasi {item}</h3>
            ...
            <Image
              fill
              src={`https://picsum.photos/seed/Laporan-${item}/2000/2000`}
              alt="LPSK"
